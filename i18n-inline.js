...
window.STGraphXI18nBundles.pt = {
  ...
  "action.tabletCanvasEdit": "Modo de edicao do canvas",
  "action.tabletCanvasPan": "Modo de navegacao do canvas",
  "aria.close": "Fechar",
  ...
  "menu.help.examples": "Modelos de exemplo...",
  "panel.model": "Modelo",
  "panel.node": "Nó",
  "panel.edge": "Seta",
  "panel.widget": "Widget",
  ...
  "tooltip.menu.help.examples": "Abrir uma página com os modelos de exemplo incluídos no aplicativo.",
  "examples.title": "Modelos de exemplo",
  "examples.intro": "Abra um dos modelos incluídos na pasta examples para explorar casos de uso e funções do aplicativo.",
  "examples.open": "Abrir",
  "examples.openError": "Não foi possível abrir o modelo de exemplo.",
  ...
  "node.widgetControlled": "Nó controlado por um widget de entrada.",
  ...
  "widget.binaryFalseLabel": "Texto para 0",
  "widget.binaryTrueLabel": "Texto para 1",
  "widget.binaryLabelPlaceholder": "Deixe vazio para nenhum texto",
  "widget.ledTitle": "LED {id}",
