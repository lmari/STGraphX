...
window.STGraphXI18nBundles = {
  "it": {
    ...
    "expr.help.max": "Massimo tra `x1`, `x2`, ... .",
    "expr.help.min": "Minimo tra `x1`, `x2`, ... .",
    "expr.help.not": "Negazione logica (equivalente a `!`). Esempio: not x.",
    ...
    "expr.help.pos": "Restituisce `x` se `x` e positivo, e `0` altrimenti.",
    "expr.help.pow": "Potenza: `base` elevata a `exp`.",
    "expr.help.round": "Arrotondamento all'intero più vicino di `x`.",
    "expr.help.sign": "Segno di `x`: `-1`, `0` o `1`.",
    "expr.help.sin": "Seno di `x`.",
