...
assert.deepEqual(context.window.GraphSemantics.evaluateValueExpression("append([1], 2, [3,4])").value, [1, 2, 3, 4]);
assert.deepEqual(context.window.GraphSemantics.evaluateValueExpression("append([[1,2]], [3,4], [5,6])").value, [[1, 2], [3, 4], [5, 6]]);
assert.deepEqual(context.window.GraphSemantics.evaluateValueExpression("append([[1,2],[3,4]], [5,6], 0)").value, [[1, 2], [3, 4], [5, 6]]);
assert.deepEqual(context.window.GraphSemantics.evaluateValueExpression("append([[1,2],[3,4]], [5,6], 1)").value, [[1, 2, 5], [3, 4, 6]]);
assert.deepEqual(context.window.GraphSemantics.evaluateValueExpression("append([[1,2],[3,4]], [5,6], [7,8], 1)").value, [[1, 2, 5, 7], [3, 4, 6, 8]]);
assert.deepEqual(context.window.GraphSemantics.evaluateValueExpression("append([5,6], [[1,2],[3,4]], 0)").value, [[5, 6], [1, 2], [3, 4]]);
assert.deepEqual(context.window.GraphSemantics.evaluateValueExpression("append([5,6], [[1,2],[3,4]], 1)").value, [[5, 1, 2], [6, 3, 4]]);
assert.deepEqual(context.window.GraphSemantics.evaluateValueExpression("append([5,6], [[1,2],[3,4]])").value, [[5, 6], [1, 2], [3, 4]]);
assert.deepEqual(context.window.GraphSemantics.evaluateValueExpression("append([5,6], [[1,2],[3,4]], [7,8], 1)").value, [[5, 1, 2, 7], [6, 3, 4, 8]]);
assert.deepEqual(context.window.GraphSemantics.evaluateValueExpression("append([1,2], [3,4], 1)").value, [1, 2, 3, 4, 1]);
assert.deepEqual(context.window.GraphSemantics.evaluateValueExpression("resize([1,2], 4)").value, [1, 2, 0, 0]);
assert.deepEqual(context.window.GraphSemantics.evaluateValueExpression("resize([1,2,3], 2)").value, [1, 2]);
assert.deepEqual(context.window.GraphSemantics.evaluateValueExpression("resize([[1,2],[3,4]], 3, 4)").value, [[1, 2, 0, 0], [3, 4, 0, 0], [0, 0, 0, 0]]);
assert.deepEqual(context.window.GraphSemantics.evaluateValueExpression("resize([[1,2],[3,4]], 1, 3)").value, [[1, 2, 0]]);
assert.deepEqual(context.window.GraphSemantics.evaluateValueExpression("resize([], 2, 3)").value, [[0, 0, 0], [0, 0, 0]]);
assert.equal(context.window.GraphSemantics.evaluateValueExpression("resize([1,2], -1)").ok, false);
assert.equal(context.window.GraphSemantics.evaluateValueExpression("resize(agents([\"X\"], 1), 2, 1)").ok, false);
assert.equal(context.window.GraphSemantics.evaluateValueExpression("append([[1,2],[3,4]], [5], 1)").ok, false);
assert.equal(context.window.GraphSemantics.evaluateValueExpression("append([[1,2],[3,4]], [5,6], 2)").ok, false);
assert.equal(context.window.GraphSemantics.evaluateValueExpression("append([1])").ok, false);
